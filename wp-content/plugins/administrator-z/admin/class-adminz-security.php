	        	...
	        	<tr valign="top">	        		
	        		...
	        		<td>
	        			<div>
	        				...
	        				?>
	        				<input type="checkbox" <?php echo $checked; ?>  name="adminz_security[adminz_xmlrpc_enabled]"/>
	        			</div>
	        		</td>
	        	</tr>
	        	<tr valign="top">	        		
	        		...
	        		<td>
	        			<div>
	        				...
	        				?>
	        				<input type="checkbox" <?php echo $checked; ?>  name="adminz_security[adminz_disable_x_pingback]"/>
	        			</div>
	        		</td>
	        	</tr>
	        	<tr valign="top">	        		
	        		...
	        		<td>
	        			<div>
	        				...
	        				?>
	        				<input type="checkbox" <?php echo $checked; ?>  name="adminz_security[adminz_disable_json]"/>
	        			</div>
	        		</td>
	        	</tr>
	        	<tr valign="top">	        		
	        		...
	        		<td>
	        			<div>
	        				...
	        				?>
	        				<input type="checkbox" <?php echo $checked; ?>  name="adminz_security[adminz_disable_file_edit]"/>
	        			</div>
	        		</td>
	        	</tr>
	        </table>
