...
class ADMINZ_Import extends Adminz {
    ...
    function do_import_single($link = false){
        ...
        if(!$post_id){
            wp_send_json_success('<div><code>Cannot import!</code><button class="button single_post_import_in_list" type="button">Import</button></div>');
            wp_die();
        }
    ...
    function do_import_single_product($link = false) {
        ...
        $product_id = $product->save();
        if(!$product_id){
            wp_send_json_success('<div><code>Cannot import!</code><button class="button single_product_import_in_list" type="button">Import</button></div>');
            wp_die();
        }
        return $product_id;
    }
    ...
    function run_import_single($link = false) {
        ...
        wp_send_json_success("<a target='_blank' href='".get_permalink( $post_id )."'>Complete</a>".'<button class="button single_post_import_in_list" type="button">Import</button>');
        wp_die();
    }
    function run_import_single_product($link = false){
        if(!$link){ $link = $_POST['link']; }
        $post_id = $this->do_import_single_product($link);
        wp_send_json_success("<a target='_blank' href='".get_permalink( $post_id )."'>Complete</a>".'<button class="button single_product_import_in_list" type="button">Import</button>');
        wp_die();
    }
    ...
    function fix_product_price($price){
        // fix for decima
        return $price/pow(10,$this->get_option_value('adminz_import_content_product_decimal_seprator'));
    }
                                ...
                                if(response.success) {
                                    ...
                                    if(!data_test.length){
                                        ...
                                        for (var i = 0; i < data_test.length; i++) {                                            
                                            html_test +='<tr data-link="'+data_test[i]['post_url']+'"> <td class="status" style="width: 30%;"><button class="button single_post_import_in_list" type="button">Import</button></td><td><p>'+data_test[i]['post_title']+'</p><a target="_blank" href="'+data_test[i]['post_url']+'">Link</a></td></tr>';
                                        }                                       
                                        html_test +='</table>';
                                        html_test +="</div>";
                                    }
                            ...
                            success: function(response) {
                                ...
                                if(response.success) {
                                    ...
                                    if(!data_test.length){
                                        ...
                                        html_test +='<table>';
                                        for (var i = 0; i < data_test.length; i++) {                                            
                                            html_test +='<tr data-link="'+data_test[i]['post_url']+'"> <td class="status" style="width: 30%;"><button class="button single_product_import_in_list" type="button">Import</button></td><td><p>'+data_test[i]['post_title']+'</p><a target="_blank" href="'+data_test[i]['post_url']+'">Link</a></td></tr>';
                                        }                                       
                                        html_test +='</table>';
                                        html_test +="</div>";
                                    }
        ...
        do_settings_sections($this->options_group);
            ...
            <table class="form-table table_imports">
                ...
                <tr valign="top">
                    ...
                    <td>
                        <label>
                            <input type="url" name="adminz_import[adminz_import_from_category]" placeholder="https://test.minhkhang.net/?page_id=83" value="<?php echo $this->get_option_value('adminz_import_from_category'); ?>"> 
                        </label>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <label>
                            <input type="url" name="adminz_import[adminz_import_from_product]" placeholder="https://test.minhkhang.net/?p=223" value="<?php echo $this->get_option_value('adminz_import_from_product'); ?>"> 
                        </label>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <label>
                            <input type="url" name="adminz_import[adminz_import_from_product_category]" placeholder="https://test.minhkhang.net/?post_type=product" value="<?php echo $this->get_option_value('adminz_import_from_product_category'); ?>"> 
                        </label>
        ...
        <?php echo $this->tool_script(); ?>
            <table class="form-table">
                ...
                <tr valign="top">                   
                    ...
                    <td>
                        <p>
                            <input type="text" name="adminz_import[adminz_import_post_title]" placeholder='.article-inner .entry-header .entry-title' value="<?php echo $this->get_option_value('adminz_import_post_title'); ?>" />
                            <code>Title wrapper</code>
                        </p>
                        <p>
                            <input type="text" name="adminz_import[adminz_import_post_thumbnail]" placeholder='.article-inner .entry-header .entry-image' value="<?php echo $this->get_option_value('adminz_import_post_thumbnail'); ?>" />
                            <code>Thumbnails wrapper</code>
                        </p>
                        <p>
                            <input type="text" name="adminz_import[adminz_import_post_content]" placeholder='.article-inner .entry-content' value="<?php echo $this->get_option_value('adminz_import_post_content'); ?>" />
                            <code>Content wrapper</code>
                        </p>
                        <p>
                            <input type="text" name="adminz_import[adminz_import_post_category]" placeholder='.entry-category a' value="<?php echo $this->get_option_value('adminz_import_post_category'); ?>" />
                            <code>Category <mark>Incomplete</mark></code>
                        </p>
                        <p>
                            <input type="text" name="adminz_import[adminz_import_post_date]" placeholder='.posted-on time.entry-date' value="<?php echo $this->get_option_value('adminz_import_post_date'); ?>" />
                ...
                <tr valign="top">                   
                    ...
                    <td>
                        <p>
                            <input type="text" name="adminz_import[adminz_import_category_post_item]" placeholder='#post-list article' value="<?php echo $this->get_option_value('adminz_import_category_post_item'); ?>" />
                            <code>Post item wrapper</code>
                        </p>     
                        <p>
                            &rdsh;<input type="text" name="adminz_import[adminz_import_category_post_item_link]" placeholder='.more-link' value="<?php echo $this->get_option_value('adminz_import_category_post_item_link'); ?>" />
                ...
                <tr valign="top">                   
                    ...
                    <td>
                        <p>
                            <input type="text" name="adminz_import[adminz_import_product_header_title]" placeholder='.product-info' value="<?php echo $this->get_option_value('adminz_import_product_header_title'); ?>" />
                            <code>Header information wrapper</code>
                        </p>
                        <p>
                            <input type="text" name="adminz_import[adminz_import_product_title]" placeholder='.product-info>.product-title' value="<?php echo $this->get_option_value('adminz_import_product_title'); ?>" />
                            <code>Title wrapper</code>
                        </p>
                        <p>
                            <input type="text" name="adminz_import[adminz_import_product_prices]" placeholder='.product-info .price-wrapper .woocommerce-Price-amount' value="<?php echo $this->get_option_value('adminz_import_product_prices'); ?>" />
                            <code>Prices</code>
                        </p>
                        <p>
                            <input type="text" name="adminz_import[adminz_import_product_single_add_to_cart_button]" placeholder='.product-info .single_add_to_cart_button' value="<?php echo $this->get_option_value('adminz_import_product_single_add_to_cart_button'); ?>" />
                            <code>Single add to cart button</code>
                        </p>
                        <p>
                            <input type="text" name="adminz_import[adminz_import_product_variations_json]" placeholder='.product-info .variations_form' value="<?php echo $this->get_option_value('adminz_import_product_variations_json'); ?>" />
                            <code>Variations json data</code>
                        </p>
                        <p>
                            <input type="text" name="adminz_import[adminz_import_product_variations_form_select]" placeholder='.product-info .variations' value="<?php echo $this->get_option_value('adminz_import_product_variations_form_select'); ?>" />
                            <code>Variations form select</code>
                        </p>
                        <p>
                            <input type="text" name="adminz_import[adminz_import_product_grouped_form]" placeholder='.product-info .grouped_form' value="<?php echo $this->get_option_value('adminz_import_product_grouped_form'); ?>" />
                            <code>Grouped form</code>
                        </p>
                        <p>
                            <input type="text" name="adminz_import[adminz_import_product_short_description]" placeholder='.product-info .product-short-description' value="<?php echo $this->get_option_value('adminz_import_product_short_description'); ?>" />
                            <code>Excerpt wrapper</code>
                        </p>
                        <p>
                            <input type="text" name="adminz_import[adminz_import_product_thumbnail]" placeholder='.woocommerce-product-gallery__image' value="<?php echo $this->get_option_value('adminz_import_product_thumbnail'); ?>" />
                            <code>Gallery wrapper</code>
                        </p>
                        <p>
                            &rdsh;<input type="text" name="adminz_import[adminz_import_product_thumbnail_tag]" placeholder='img' value="<?php echo $this->get_option_value('adminz_import_product_thumbnail_tag'); ?>" />
                            <code>Gallery item tag</code>
                        </p>
                        <p>
                            &rdsh;<input type="text" name="adminz_import[adminz_import_product_thumbnail_data_attr]" placeholder='data-src' value="<?php echo $this->get_option_value('adminz_import_product_thumbnail_data_attr'); ?>" />
                            <code>Gallery item data attribute</code>
                        </p>                        
                        <p>
                            <input type="text" name="adminz_import[adminz_import_product_content]" placeholder='.woocommerce-Tabs-panel--description' value="<?php echo $this->get_option_value('adminz_import_product_content'); ?>" />
                            <code>Content wrapper </code>| Warning: Select <b>Inside</b> a description tab content for reason: default hide tab css
                        </p> 
                        <p>
                            <input type="text" name="adminz_import[adminz_import_product_category]" placeholder='.entry-category a' value="<?php echo $this->get_option_value('adminz_import_product_category'); ?>" />
                            <code>Category <mark>Incomplete</mark></code>
                        </p>
                        <p>
                            <input type="text" name="adminz_import[adminz_import_product_date]" placeholder='.posted-on time.entry-date' value="<?php echo $this->get_option_value('adminz_import_product_date'); ?>" />
                            <code>Posted On <mark>Incomplete</mark></code>
                        </p>
                        <p>
                            <input type="text" name="adminz_import[adminz_import_product_attr]" placeholder='.posted-on time.entry-date' value="<?php echo $this->get_option_value('adminz_import_product_attr'); ?>" />
                ...
                <tr valign="top">                   
                    ...
                    <td>
                        <p>
                            <input type="text" name="adminz_import[adminz_import_category_product_item]" placeholder='.products .product' value="<?php echo $this->get_option_value('adminz_import_category_product_item'); ?>" />                            
                            <code>Item wrapper</code>
                        </p>   
                        <p>
                            &rdsh;<input type="text" name="adminz_import[adminz_import_category_product_item_link]" placeholder='.box-image a' value="<?php echo $this->get_option_value('adminz_import_category_product_item_link'); ?>" />
                ...
                <tr valign="top">                   
                    ...
                    <td>
                        <p>                         
                            <textarea rows="3" cols="40%" class="input-text wide-input " placeholder="-280x280&#10;-400x400" type="text" name="adminz_import[adminz_import_thumbnail_url_remove_string]" ><?php echo $this->get_option_value('adminz_import_thumbnail_url_remove_string'); ?></textarea><br>
                        </p>                        
                ...
                <tr valign="top">                   
                    ...
                    <td>
                        <p>
                        <label>
                            <input type="text" value="<?php echo $this->get_option_value('adminz_import_content_remove_attrs');?>" placeholder = "a" name="adminz_import[adminz_import_content_remove_attrs]"/>
                            <code>Remove Attributes for Tags</code> | Tags are separated by commas
                        </label>
                        </p>
                        <p>
                        <label>
                            <input type="text" value="<?php echo $this->get_option_value('adminz_import_content_remove_tags');?>" placeholder = "iframe,script,video,audio" name="adminz_import[adminz_import_content_remove_tags]"/>
                            <code>Remove HTML Tags</code> | Tags are separated by commas
                        </label>
                        </p>
                        <p>                         
                            <input type="number" name="adminz_import[adminz_import_content_remove_first]" placeholder = '0' value="<?php echo $this->get_option_value('adminz_import_content_remove_first'); ?>" />
                        ...
                        <p>                         
                            <input type="number" name="adminz_import[adminz_import_content_remove_end]" placeholder = '0' value="<?php echo $this->get_option_value('adminz_import_content_remove_end'); ?>" />
                        ...
                        <p>
                            <input type="text" name="adminz_import[adminz_import_content_thumbnail_data_attr]" placeholder='src' value="<?php echo $this->get_option_value('adminz_import_content_thumbnail_data_attr'); ?>" />
                ...
                <tr valign="top">                   
                    ...
                    <td>
                        <p>
                            <input type="number" name="adminz_import[adminz_import_content_product_decimal_seprator]" placeholder='2' value="<?php echo $this->get_option_value('adminz_import_content_product_decimal_seprator'); ?>" />
